...
# In this next example, we'll save the file to a PDF 
# and chop off extra white space around the graph; 
# this is useful when wanting to use figures in LaTeX. 
# We'll also increase the line widths, 
# shrink the axis font size, 
# and tilt the x-axis labels by 45 degrees.
...
pdf(file="/Users/veronicagosnell/Desktop/R/R.Module9/figure.pdf", height=3.5, width=5)
...
#doesn't print anything in environment, but does save correct pdf
