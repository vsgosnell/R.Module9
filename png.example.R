...
# created a tab-delimited file using data from ^
# called autos.dat.txt 
...
png(filename="/Users/veronicagosnell/Desktop/R/R.Module9/figure.png", height=295, width=300, 
    bg="white")
...
#doesnt print out anything, but saves correct plot to figure.png
